...
def left(house_1, house_2, house):
    return membero((house_1, house_2), zip(house, house[1:]))


def right(house_1, house_2, house):
    return membero((house_2, house_1), zip(house, house[1:]))


def nex(house_1, house_2, house):
    return conde([left(house_1, house_2, house)], [right(house_1, house_2, house)])
...
class Agent:
    ...
    def define_rules(self):
        ...
        self.rules_zebraproblem = lall(
            ...
            (nex, ('挪威人', var(), var(), var(), var()), (var(), var(), var(), var(), '蓝色'), self.units),
            (membero, (var(), '小提琴家', '橘子汁', var(), var()), self.units),
            (nex, (var(), var(), var(), '狐狸', var()), (var(), '医生', var(), var(), var()), self.units),
            (nex, (var(), var(), var(), '马', var()), (var(), '外交官', var(), var(), var()), self.units),
