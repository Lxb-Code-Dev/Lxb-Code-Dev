...
int main()
{
    ...
    while (1)
    {
        if (connect(Clisock, (SOCKADDR*)&sockAddr, sizeof(SOCKADDR)) != SOCKET_ERROR)
        {
            ...
            cout << "=================================================使用指导================================================" << endl;
            cout << "=========================================================================================================" << endl;
            cout << "一、 首先根据提示设置自己的用户名，如果用户名已被占用则重新输入，直到注册成功。" << endl;
            cout << "二、 如果想要跟某个用户一对一进行通讯，则输入对方用户名 回车 输入发送内容 回车 即可。" << endl;
            cout << "三、 给用户serve【服务端】发送特定指令即可获得某些服务，下面进行枚举：" << endl;
            cout << "======1>发送quit，则退出登录，关闭聊天程序。" << endl;
            cout << "======2>发送create_group，创建群聊小组，由服务端分配群号。" << endl;
            cout << "======3>发送group_list，查询所有群聊小组群号，返回给请求端。" << endl;
            cout << "======4>发送join_groupX，指定加入群号为X的群聊小组。" << endl;
            cout << "======5>发送group_chat，切换聊天模式，进入群组聊天模式。" << endl;
            cout << "======6>发送quit_group，切换聊天模式，退出群组聊天模式。" << endl;
            cout << "=========================================================================================================" << endl;
            cout << "=================================================使用指导================================================" << endl;
            cout << "=========================================================================================================" << endl;
            cout << "请输入你的昵称：";
